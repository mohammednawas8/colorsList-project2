...
let colorsList = [
    ColorInfo(value: UIColor(red: 30/255, green: 76/255, blue: 99/255, alpha: 1),
              name: "Deep Teal",
              description: "Deep Teal - \(sharedDescription)"),
    ColorInfo(value: UIColor(red: 16/255, green: 45/255, blue: 118/255, alpha: 1),
              name: "Catalina Blue",
              description: "Catalina Blue - \(sharedDescription)"),
    ColorInfo(value: UIColor(red: 24/255, green: 11/255, blue: 79/255, alpha: 1),
              name: "Dark Indigo",
              description: "Dark Indigo - \(sharedDescription)"),
    ColorInfo(value: UIColor(red: 63/255, green: 16/255, blue: 86/255, alpha: 1),
              name: "Ripe Blum",
              description: "Ripe Blum - \(sharedDescription)"),
    ColorInfo(value: UIColor(red: 78/255, green: 23/255, blue: 42/255, alpha: 1),
              name: "Mulberry Wood",
              description: "Mulberry Wood - \(sharedDescription)"),
    ColorInfo(value: UIColor(red: 120/255, green: 31/255, blue: 14/255, alpha: 1),
              name: "Kenyan Copper",
              description: "Kenyan Copper - \(sharedDescription)"),
    ColorInfo(value: UIColor(red: 115/255, green: 48/255, blue: 16/255, alpha: 1),
              name: "Chestunt",
              description: "Chestunt - \(sharedDescription)"),
    ColorInfo(value: UIColor.black,
              name: "Black",
              description: "Black - \(sharedDescription)"),
    ColorInfo(value: UIColor.orange,
              name: "Orange",
